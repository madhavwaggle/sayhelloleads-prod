...
${callIntentDetected ? `CALL REQUEST — HIGHEST PRIORITY:
The lead has asked to be called. STOP qualifying immediately.
Do NOT ask about timeline, budget, or pre-approval.
${calendlyUrl
  ? `Reply: confirm the call and offer the booking link: "Absolutely — here's a link to grab a time: ${calendlyUrl} — takes 30 seconds!"`
  : `Reply: confirm and propose 2 specific times: "Absolutely — I have [tomorrow at 10am] or [Thursday at 2pm] — which works for you?"`}
One warm sentence + the offer. Nothing else.`
: `SCHEDULING:
${calendlyUrl
